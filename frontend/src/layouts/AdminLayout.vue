...
<template>
  <div class="min-h-screen bg-white dark:bg-slate-950 flex flex-col">
    ...
    <div class="flex flex-1">
      <aside class="w-16 shrink-0 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 z-40">
        <div class="sticky top-16 flex flex-col items-center py-4 gap-2">
          <div class="mb-4 pb-4 border-b border-slate-100 dark:border-slate-800 w-full flex justify-center">
            ...
            >
              ...
              <div class="absolute left-14 px-4 py-2 rounded-xl bg-slate-900 dark:bg-blue-600 text-white text-sm font-bold whitespace-nowrap opacity-0 -translate-x-3 pointer-events-none transition-all group-hover:opacity-100 group-hover:translate-x-0 z-100 shadow-2xl">
                总览
